<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($type=='post'){
            ...
            try{
                $status = create_agent($user, $pass, $name, $bank_n, $bank_account);
        ...
        <div class="coinbuy_wrapper">
            ...
            <div class="coinbuy_right w-100">
                ...
                <div class="content_body">
                    <h3 class="content_title">에이전트</h3>
                    <div class="row">
                            ...
                            <div class="table_wrap agency_table_wrap">
                                <div class="table_top pt_20">
                                    <div class="table_top_right table_top_right1">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#exampleModal02"  class="button">에이전트 등록</a>
                                    </div>
                                </div>
                                <table class="w-100 agent_table td_height">
                                    <tr>
                                    	<th>번호</th>
                                        <th>에이전시</th>
                                        <th>메모</th>
                                        <th>파트너</th>
                                        <th>회원수</th>
                                        <th>월별 구매금액</th><!-- 월별 구매금액, 누적 구매금액 -->
                                        <th></th>
                                    </tr>
                                   
                                    <tr class="table_data">
                                    <?php
                                            $query="SELECT * from agent ORDER BY `creation_date` DESC";
                                        ...
                                        <td>
                                           <p><?php echo $array[6];?> - <span class="green">0.3%</span></p>
                                        </td>
                                        <td>
                                            <p><?php echo $array[7];?></p>
                                        </td>
                                        <td><p><?php echo $array[8];?></p></td>
                                        <td><p><?php echo $array[9];?></p></td>

<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if($type=='post'){
            ...
            try{
                $status = create_partner($user, $pass, $name, $bank_n, $bank_account);
                            ...
                            <div class="table_wrap agency_table_wrap admin_coin_buy">
                                <div class="table_top pt_20">
                                    <div class="table_top_right table_top_right1">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#exampleModal02" class="button">파트너 등록</a>
                                    </div>
                                </div>
                                <table class="w-100 partner_table td_height">
                                    <tr>
                                    	<th>번호</th>
                                        <th>파트너</th>
                                        <th>메모</th>    
                                    ...
                                    <tr class="table_data">
                                    <?php
                                            $query="SELECT * from partner ORDER BY `creation_date` DESC";
                                        ...
                                        <td>
                                           <p><?php echo $array[3];?><span class="green">-0.9%</span></p>
                                        </td>
                                        <td>
                                        ...
                                        <?php include '../admin/update_partner.php';?>
                                    </tr>
                                    <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr>
                                ...
                                <table class=" partner_table partner_table2 agency_table agency_table2 td_height mt_5">
                                    <tr>
                                        <th></th>
                                        <th></th>
                                        <th></th>
                        ...
                        <div class="coinbuy_modal_content_wrap">
                            <form id="contactForm" method="POST" class="login_form account_form" role="form">
                                <div class="row reg_row">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="input_box input_box1">
                                            <label for="id">Account Holder</label>

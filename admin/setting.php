        ...
        <div class="coinbuy_wrapper">
            ...
            <div class="coinbuy_right w-100">
                ...
                <div class="content_body">
                    <h3 class="content_title">계좌 설정</h3>
                    <div style="margin-top: 7px;" id="status"></div>
                    <div class="row">
                        <div class="col-lg-12 pt_25">
                            <div class="table_wrap height_table">
                                <div class="table_top">
                                    <div class="table_top_right table_top_right1">
                                       <div class="input_box">
                                        ...
                                        <a href="#" data-toggle="modal" data-target="#exampleModal02" class="button admin_audio">판매자 등록</a>
                                    </div>
                                </div>
                                <table class="coinbuy_table admin_table admin_account_table">
                                    <tr>
                                    	<th>번호</th>
                                        <th>파트너</th>
                                        <th>메모</th>
                                    ...
                                    <tr class="table_data">
                                        <?php
                                            ...
                                            $query="SELECT * from members WHERE type='seller' ORDER BY `creation_date` DESC";
                                        ...
                                        <td>
                                            <p><?php echo $array[12];?></p>
                                        </td>
                                        <td><p><?php echo $array[4];?></p></td>
                                        <td><p><?php echo $array[5];?></p></td>
                                        <td><p><?php echo $array[3];?></p></td>
                                        <td>
                                            <p><?php echo $array[9];?></p>
                                        </td>
                                        <td class="admin_table_btn">
                                            <div class="line"></div>
                                            <a href="#"  data-toggle="modal" data-target="#edit<?php echo $array[0]; ?>" class="button admin_audio">계좌 수정하기</a>
                                        </td> 
                                        <?php include '../admin/update_setting.php';?>
                                    </tr>
                                    <?php endwhile; ?>
                                    <?php else: ?>
                                        <tr>
                        ...
                        <div class="coinbuy_modal_content_wrap">
                            <form id="contactForm" method="POST" class="login_form account_form" role="form">
                                ...
                                <div class="login_btn text-center">
                                    <button class="button" id="submit_button" type="submit">회원가입</button>
                                </div>  
                            </form>
                        </div>
                    </div>

<?php
            if($_SERVER['REQUEST_METHOD'] == 'POST') {
                ...
                if($type=="put"){
                    ...
                    $agency = $_POST['agency'];
                    $status = edit_memberM($id, $agent, $agency, $partner);
                                ...
                                <input type="hidden" name="ids" id="ids" value="<?php echo $array[0];?>">                         
                                    <div class="col-lg-12">
                                        <div class="input_box input_box1">
                                            ...
                                            <input type="text" value="<?php echo $array[2];?>">
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        <div class="input_box input_box1">
                                    ...
                                    <div class="col-6">
                                        <div class="input_box">
                                            ...
                                            <input type="text" value="<?php echo $array[7];?>">
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="input_box">
                                            <label for="account">Bank Account</label>
                                            <input type="text" value="<?php echo $array[8];?>">
                                        </div>
                                    </div>
                                    <!-- <div class="col-lg-12">
                                        <div class="input_box input_box1">
                                    ...
                                    <div class="col-6">
                                        <div class="input_box">
                                            ...
                                            <?php $querys="SELECT * from agent ORDER BY `creation_date` DESC";
                                                $results=mysqli_query($con,$querys);?>
                                                <?php if ($results->num_rows > 0): ?>
                                                <?php while($arr=mysqli_fetch_row($results)): ?>
                                    ...
                                    <div class="col-6">
                                        <div class="input_box">
                                            <label for="bank">Agency</label>
                                            <select name="agency" id="agency">
                                            <?php $querys="SELECT * from agency ORDER BY `creation_date` DESC";
                                                $results=mysqli_query($con,$querys);?>
                                                <?php if ($results->num_rows > 0): ?>
                                                <?php while($arr=mysqli_fetch_row($results)): ?>

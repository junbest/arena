        ...
        <div class="coinbuy_wrapper">
            <div class="coinbuy_left">
                                ...
                                <div class="menu_drop_right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="../agent/profile">프로필</a>
                                            <a class="dropdown-item" href="../agent/logout">로그아웃</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <ul class="menu_area">
                    ...
                    <li>
                        <a href="../agent/member" class="active">
                            <div>

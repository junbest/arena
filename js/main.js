(function ($) {
    ...
    $(window).on('load', function(){
        ...
        // ------ 03_coinbuy_01_modal_01 show -------
        $('#coinbuy_modal_auto').modal('show');

        // ------ question_alert1 show -------
        $('#question_alert1').modal('show');
    });
    ...
    $(document).ready(function () {
        ...
        $('.button').click(function(){
            ...
            $('#exampleModal02').removeAttr('class').addClass(buttonId);
            $('body').addClass('modal-active');
          })
          
          $('#exampleModal02').click(function(){
            $(this).addClass('out');

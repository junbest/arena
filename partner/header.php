    ...
    <main>
        ...
        <div class="coinbuy_wrapper">
            <div class="coinbuy_left">
                                ...
                                <div class="menu_drop_right">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu">
                                            <a class="dropdown-item" href="../partner/profile">프로필</a>
                                            <a class="dropdown-item" href="../partner/logout">로그아웃</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <p class="sidebar_heading">COIN TRADER</p>
                <ul class="menu_area menu_area2">
                    <li>
                        <a href="../partner/member">
                            <div>
                    ...
                    <li>
                        <a href="../partner/coinsell" class="active">
                            <div>
                    ...
                    <li>
                        <a href="../partner/logout">
                            <div>
                                <img src="../img/icon17.svg" class="img-fluid" alt="">
                                <span class="hide_text">로그아웃</span>
                            </div>
                            <div>
                                <i class="far fa-angle-right"></i>
                            </div>
